...
export default function Analises(props) {
    const [topClientesQuantidade, setTopClientesQuantidade] = useState([]);
    const [produtosServicos, setProdutosServicos] = useState([]);
    const [consumoPorTipoERaca, setConsumoPorTipoERaca] = useState([]);
    const [topClientesValor, setTopClientesValor] = useState([]);
